...
path_to_txt = '../data/Raw_Text'
texts = os.path.abspath(path_to_txt)
txt_files = [file for file in os.listdir(texts)]

processed_docs = []
for txt_file in tqdm(txt_files):
    documents = []
    with open(os.path.abspath(path_to_txt + os.path.sep + txt_file), 'r') as f:
        text = f.read()
        doc = Document(
        page_content = text,
